...
// Y is negated relative to the source SVG (which uses SVG's y-down convention)
// to match OpenSCAD's y-up 2D plane — skipping this produced upside-down glyphs
// (still correctly ordered left-to-right, but each letter mirrored vertically).
wordmark_points = [
