 ...
 *       Consolidated into a single file with export toggles for copy-paste workflow.
...
// ==========================================
// --- PART SELECTION (Set ONE to true) ---
// ==========================================
export_housing        = true;
export_back_panel     = false;
export_grille_inserts = false;
// ==========================================
...
if (export_back_panel) {
    back_panel_flat();
}

if (export_grille_inserts) {
...
// Toddler-safe flush-mount hex grille insert
