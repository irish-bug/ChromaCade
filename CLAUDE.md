...
- **`color-palette.md`** — candidate hex values for the note key colors. Letter-to-color assignment and chord-blend validation are still open (see `open-questions.md`).
